from server.src.games.CurrencyRouletteGame import calculate_money_interval
from server.src.games.GuessGame import compare_results
from server.src.games.MemoryGame import is_list_equal
from server.src.utils.games_utils import is_in_range
