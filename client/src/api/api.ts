...
export const getGuessGame = async (difficult: number, setGuessGame: Function) => {
    try{
      const { data } = await axios.get(`${BASE_URL}/guess?difficult=${difficult}`);
      console.log(data);
      setGuessGame(data);
    } catch (err) {
...
export const getMemoryGame = async (difficult: number, setMemoryGame: Function) => {
    try{
      const { data } = await axios.get(`${BASE_URL}/memory?difficult=${difficult}`);
      setMemoryGame(data);
    } catch (err) {
...
export const getCurrencyGame = async (difficult: number, setCurrencyGame: Function) => {
    try{
      const { data } = await axios.get(`${BASE_URL}/currency?difficult=${difficult}`);
